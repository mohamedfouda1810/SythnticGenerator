...
@pytest.mark.asyncio
async def test_history_detail(client: AsyncClient, sample_mimesis_schema: dict) -> None:
...
@pytest.mark.asyncio
async def test_delete_job(client: AsyncClient, sample_mimesis_schema: dict) -> None:
...
@pytest.mark.asyncio
async def test_history_default_pagination(
    client: AsyncClient, sample_mimesis_schema: dict
) -> None:
